...
<!-- Did Figure 15-4 (trpln15-01.svg that I sent) help at all? /Carol-->
...
is straightforward except for its recursiveness, so the concepts in this
example will be useful any time you get into more complex situations involving
recursive types.
...
type needs, the complier looks at the variants, starting with the `Cons`
